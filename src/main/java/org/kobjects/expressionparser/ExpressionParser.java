...
public class ExpressionParser<T> {
  ...
  public static class Processor<T> {
    ...
    public T emoji(Tokenizer tokenizer, String value) {
      throw new UnsupportedOperationException("emoji(" + value + ')');
    }
  ...
  /**
   * Processor the given expression using a simple StreamTokenizer-based parser.
  ...
  /**
   * Processor an expression from the given tokenizer. Leftover tokens will be ignored and
